...
class ReviewsSpider(Spider):
    ...
    def parse_review_details(self, response):
        ...
        review['comment_date'] = main.xpath('header[@class="main-hd"]/span[@class="main-meta"]/text()').split(' ')[0]
        review['comment_time'] = main.xpath('header[@class="main-hd"]/span[@class="main-meta"]/text()').split(' ')[1]
